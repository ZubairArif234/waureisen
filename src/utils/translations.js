const translations = {
  en: {
    ...
    booking_created_msg:
      "Your booking had been created successfully , Once the provider confirms it , you'll receive the notification via email.",
    ...
    invoice_available_after_checkin: "invoice available after checkin",
    checkout_time: "Checkout Time",
    checkin_time: "Checkin Time",
    no_smoking: "no smoking",
    no_event: "no events or parties",
    no_hours: "quite hours after 10 PM",
    //filter translation start
    "Dog Facilities": "Dog Facilities",
    "Private Garden": "Private Garden",
    "No Leash Required": "No Leash Required",
    "Fenced Garden 100 cm": "Fenced Garden 100 cm",
    "Fenced Terrace": "Fenced Terrace",
    "Dog Stays Free of Charge": "Dog Stays Free of Charge",
    "Fenced Garden": "Fenced Garden",
    "Off-leash Meadow": "Off-leash Meadow",
    "Dog-friendly Beach Nearby": "Dog-friendly Beach Nearby",
    "Dog-friendly Restaurants": "Dog-friendly Restaurants",
    "Firework Free Zone": "Firework Free Zone",
    "Allowed at the Pool Area": "Allowed at the Pool Area",
    "Fenced Garden 150 cm": "Fenced Garden 150 cm",
    "Leash Required": "Leash Required",
    "Fenced Garden 200 cm": "Fenced Garden 200 cm",
    "Poop Bags for Free": "Poop Bags for Free",
    "Dog School": "Dog School",
    "Organized Hiking Tours with Dogs": "Organized Hiking Tours with Dogs",
    "Food Bowl": "Food Bowl",
    "Water Bowl": "Water Bowl",
    "Dog Bed": "Dog Bed",
    "Fenced Dog Park": "Fenced Dog Park",
    "Service Dog": "Service Dog",
    "Allowed in the Restaurant": "Allowed in the Restaurant",
    "Agility park nearby": "Agility park nearby",
    "Dog sitter on site": "Dog sitter on site",
    "Fenced Garden 120cm": "Fenced Garden 120cm",
    "Dog blanket": "Dog blanket",
    "Dog shower": "Dog shower",
    "Dog treats": "Dog treats",
    Mantrailing: "Mantrailing",
    "BARF menus available": "BARF menus available",
    "Dog forest nearby": "Dog forest nearby",
    "Dog park (not fenced)": "Dog park (not fenced)",
    "Permitted on the bed": "Permitted on the bed",
    "Permitted on the sofa": "Permitted on the sofa",
    "Dog menu available": "Dog menu available",
    "Dog crate": "Dog crate",
    "Dog kennel": "Dog kennel",
    "Dog room service": "Dog room service",
    "Physiotherapy for dogs": "Physiotherapy for dogs",
    "Dog shop on site": "Dog shop on site",
    "Dog trainer": "Dog trainer",
    "Dog towels": "Dog towels",
    Cage: "Cage",
    'Sign for "Dog is a guest here"': 'Sign for "Dog is a guest here"',
    "Wellness for dogs": "Wellness for dogs",

    "Facilities Parking": "Facilities Parking",
    Outdoor: "Outdoor",
    "Parking at the Accommodation": "Parking at the Accommodation",
    ...
    "Facilities Accommodation Features": "Facilities Accommodation Features",
    Tv: "Tv",
    "Free Wifi": "Free Wifi",
    "No Carpet": "No Carpet",
    Terrace: "Terrace",
    ...
    Grill: "Grill",
    Skiroom: "Skiroom",
    "Other Residents in the Building": "Other Residents in the Building",
    "Additional Bed": "Additional Bed",
    "Combination Lock": "Combination Lock",

    "Facilities Kids": "Facilities Kids",
    "Kids Friendly": "Kids Friendly",
    "Baby Bed": "Baby Bed",
    "Kids Chair": "Kids Chair",
    "Children Playground": "Children Playground",
    "Kids Pool": "Kids Pool",

    "Facilities Kitchen": "Facilities Kitchen",
    Dishwasher: "Dishwasher",
    Microwave: "Microwave",
    "Backing Oven": "Backing Oven",
    "Coffee Machine": "Coffee Machine",
    "Nespresso Machine": "Nespresso Machine",
    Freezer: "Freezer",

    "Facilities Main Filters": "Facilities Main Filters",
    "Parking at the Accommodation": "Parking at the Accommodation",
    "Kids Friendly": "Kids Friendly",
    "Fenced Garden": "Fenced Garden",
    "Private Pool": "Private Pool",
    "Dog Allowed in the Restaurant": "Dog Allowed in the Restaurant",
    "Free Cancellation": "Free Cancellation",

    "Facilities Smoking": "Facilities Smoking",
    "Non Smoking Accommodation": "Non Smoking Accommodation",
    "Smoking Accommodation": "Smoking Accommodation",

    "Facilities Sport": "Facilities Sport",
    Surf: "Surf",
    ...
    details: "Details",
    my_accommodations: "My Accommodation",
    ...
    are_you_sure:
      "Are you sure , you want to cancel your booking? This action can't be undone!",
    ...
    subscribe_newsletter:
      "Subscribe to our newsletter and don't miss any highlights",
    ...
    newsletter_description:
      "Select whether you would like to receive the Waureisen newsletter.",
    ...
    total_earnings: "Earnings Cleared",
    ...
    subscribe_newsletter:
      "Subscribe to our newsletter and don't miss any highlights",
    newsletter_opt_in: "I möchte Newsletter und Marketingmitteilungen erhalten",
    ...
    account_created_confirmation: "Your provider account has been created.",
    ...
    verification_code_info:
      "Please check your email for the verification code. It will expire in 10 minutes.",
    verifying: "Verifying...",
    submit: "Submit",
    ...
    no_dates_were_unblocked:
      "No dates were unblocked. They might already be available.",
    ...
    within_radius: "Within 150km radius",
    map_view: "Map View",
    error: "Error",
    close: "Close",
    filters: "Filters",
  ...
  about_provider:"Über den Anbieter",
    ...
    internet_connection: "Ihre Internetverbindung",
    server_not_running: "Der Server läuft nicht",
    server_different_port:
      "Der Server läuft auf einem anderen Port als erwartet",
    try_again: "Erneut versuchen",
    finding_accommodations:
      "Bitte warten Sie, während wir Unterkünfte in diesem Bereich finden...",
    ...
    booking_created: "Booking Created Successfully",
    booking_created_msg:
      "Ihre Buchung wurde erfolgreich erstellt. Sobald der Anbieter sie bestätigt hat, erhalten Sie eine Benachrichtigung per E-Mail.",
    ...
    within_radius: "Im Umkreis von 150km",
    ...
    no_event: "Keine Veranstaltungen oder Partys",
    no_hours: "ziemlich Stunden nach 22 Uhr",
    //filter translation start
    "Dog Facilities": "Hundeeinrichtungen",
    "Private Garden": "Privater Garten",
    "No Leash Required": "Keine Leine erforderlich",
    "Fenced Garden 100 cm": "Eingezäunter Garten 100 cm",
    "Fenced Terrace": "Eingezäunte Terrasse",
    "Dog Stays Free of Charge": "Hunde übernachten kostenlos",
    "Fenced Garden": "Eingezäunter Garten",
    "Off-leash Meadow": "Freilaufwiese",
    "Dog-friendly Beach Nearby": "Hundefreundlicher Strand in der Nähe",
    "Dog-friendly Restaurants": "Hundefreundliche Restaurants",
    "Firework Free Zone": "Feuerwerksfreie Zone",
    "Allowed at the Pool Area": "Erlaubt im Poolbereich",
    "Fenced Garden 150 cm": "Eingezäunter Garten 150 cm",
    "Leash Required": "Leine erforderlich",
    "Fenced Garden 200 cm": "Eingezäunter Garten 200 cm",
    "Poop Bags for Free": "Kostenlose Kotbeutel",
    "Dog School": "Hundeschule",
    "Organized Hiking Tours with Dogs": "Organisierte Wandertouren mit Hunden",
    "Food Bowl": "Futternapf",
    "Water Bowl": "Wasserschale",
    "Dog Bed": "Hundebett",
    "Fenced Dog Park": "Eingezäunter Hundepark",
    "Service Dog": "Diensthund",
    "Allowed in the Restaurant": "Im Restaurant erlaubt",
    "Agility park nearby": "Agility-Park in der Nähe",
    "Dog sitter on site": "Hundesitter vor Ort",
    "Fenced Garden 120cm": "Eingezäunter Garten 120 cm",
    "Dog blanket": "Hundedecke",
    "Dog shower": "Hundedusche",
    "Dog treats": "Leckerlis für Hunde",
    Mantrailing: "Mantrailing",
    "BARF menus available": "BARF-Menüs erhältlich",
    "Dog forest nearby": "Hundewald in der Nähe",
    "Dog park (not fenced)": "Hundepark (nicht eingezäunt)",
    "Permitted on the bed": "Auf dem Bett erlaubt",
    "Permitted on the sofa": "Auf dem Sofa erlaubt",
    "Dog menu available": "Hundemenü verfügbar",
    "Dog crate": "Hundebox",
    "Dog kennel": "Hundehütte",
    "Dog room service": "Zimmerservice für Hunde",
    "Physiotherapy for dogs": "Physiotherapie für Hunde",
    "Dog shop on site": "Hundeshop vor Ort",
    "Dog trainer": "Hundetrainer",
    "Dog towels": "Hundehandtücher",
    Cage: "Käfig",
    'Sign for "Dog is a guest here"': "Schild für „Hund ist hier zu Gast“",
    "Wellness for dogs": "Wellness für Hunde",

    "Facilities Parking": "Einrichtungen Parkplatz",
    Outdoor: "Im Freien",
    "Parking at the Accommodation": "Parken bei der Unterkunft",
    Underground: "Unterirdisch",
    "Parking Street": "Parkstraße",
    "E Charge": "E-Ladung",

    "Facilities Wellness": "Einrichtungen Wellness",
    Sauna: "Sauna",
    "Thermal Bath": "Thermalbad",
    Steambath: "Dampfbad",
    Hamam: "Hamam",
    Massage: "Massage",
    "Relaxation Zone": "Entspannungszone",
    Aquafitt: "Aquafitt",

    "Facilities Accommodation Features": "Ausstattung, Unterkunftsmerkmale",
    Tv: "Fernseher",
    ...
    Kitchen: "Küche",
    Fireplace: "Kamin",
    "Stand Alone": "Alleine stehen",
    "Washing Machine": "Waschmaschine",
    Grill: "Grill",
    Skiroom: "Skiraum",
    "Other Residents in the Building": "Andere Bewohner im Gebäude",
    "Additional Bed": "Zusatzbett",
    "Combination Lock": "Kombinationsschloss",

    "Facilities Kids": "Einrichtungen für Kinder",
    "Kids Friendly": "Kinderfreundlich",
    "Baby Bed": "Babybett",
    "Kids Chair": "Kinderstuhl",
    "Children Playground": "Kinderspielplatz",
    "Kids Pool": "Kinderbecken",

    "Facilities Kitchen": "Ausstattung Küche",
    Dishwasher: "Spülmaschine",
    Microwave: "Mikrowelle",
    "Backing Oven": "Backofen",
    "Coffee Machine": "Coffee Machine",
    "Nespresso Machine": "Kaffeemaschine",
    Freezer: "Gefrierschrank",

    "Facilities Main Filters": "Hauptfilter für Einrichtungen",
    "Parking at the Accommodation": "Parken bei der Unterkunft",
    "Kids Friendly": "Kinderfreundlich",
    "Fenced Garden": "Eingezäunter Garten",
    "Private Pool": "Privater Pool",
    "Dog Allowed in the Restaurant": "Hunde im Restaurant erlaubt",
    "Free Cancellation": "Kostenlose Stornierung",

    "Facilities Smoking": "Einrichtungen Rauchen",
    "Non Smoking Accommodation": "Nichtraucherunterkunft",
    "Smoking Accommodation": "Raucherunterkunft",

    "Facilities Sport": "Einrichtungen Sport",
    Surf: "Surfen",
    "Hiking Tour": "Wandertour",
    "Bicycle Path": "Fahrradweg",
    "Bike Tour": "Fahrradtour",
    "Horse Riding": "Reiten",
    ...
    "Facilities View": "Anlagenansicht",
    "Garden View": "Blick auf den Garten",
    "Sea View": "Meerblick",
    "Pool View": "Blick auf den Pool",
    "Mountain View": "Bergblick",
    "Lake View": "Blick auf den See",

    details: "Details",
    my_accommodations: "Meine Unterkünfte",
    ...
    no_accommodations_found: "Keine Unterkünfte gefunden",
    are_you_sure:
      "Sind Sie sicher, dass Sie Ihre Buchung stornieren möchten? Dieser Vorgang kann nicht rückgängig gemacht werden!",
    modify_search: "Suche ändern",
    ...
    no_dates_were_unblocked:
      "Es wurden keine Termine freigegeben. Möglicherweise sind sie bereits verfügbar.",
    payment_details: "Zahlungsdetails",
    per_night: "Pro nacht",

    unblock_dates: "Termine freigeben",
    select_property_to_view_dates:
      "Wählen Sie eine Immobilie, um blockierte Termine anzuzeigen",
    no_blocked_dates_for_property:
      "Keine blockierten Termine für diese Immobilie gefunden",
    ...
    error_unblocking_dates:
      "Fehler beim Freigeben der Termine. Bitte versuchen Sie es erneut",
    ...
    verification_code_info:
      "Bitte überprüfen Sie Ihre E-Mail für den Bestätigungscode. Er läuft in 10 Minuten ab.",
    verifying: "Überprüfung...",
    submit: "Absenden",
    please_verify_email:
      "Bitte verifizieren Sie Ihre E-Mail-Adresse vor der Registrierung",
    ...
    choose_contact_to_chat:
      "Wählen Sie einen Kontakt, um mit dem Chatten zu beginnen",
    ...
    ready_to_assist:
      "Unterstützt Sie mit Leidenschaft bei der Planung Ihrer hundefreundlichen Reise",
    ...
    subscribe_newsletter:
      "Newsletter abonnieren und keine Highlights mehr verpassen",
    ...
    faq: "FAQ",
    imprint: "Impressum",
    data_policy: "Datenschutzrichtlinien",
    partners: "Partner",
    contact: "Kontakt",
    ...
    host_intro:
      "Schliessen Sie sich unserer Gemeinschaft von hundefreundlichen Unterkunftsanbietern an und erzielen Sie ein Einkommen, während Sie wunderbare Erlebnisse für Gäste und ihre pelzigen Begleiter schaffen.",
    benefits_hosting: "Vorteile als Gastgeber bei Waureisen",
    benefit_heading_1: "Erhöhte Sichtbarkeit:",
    benefit_1:
      "Ihre Unterkunft wird Hundebesitzern präsentiert, die gezielt nach haustierfreundlichen Unterkünften suchen.",
    benefit_heading_2: "Einfacher Buchungsvorgang:",
    benefit_2:
      "Schnelle und unkomplizierte Buchung – optimiert für Gastgeber und Gäste mit Hund.",
    benefit_heading_3: "Zielgerichtetes Marketing:",
    benefit_3:
      "Wir erreichen genau die richtige Zielgruppe, die nach hundefreundlichen Unterkünften sucht.",
    benefit_heading_4: "Vertrauen & Sicherheit:",
    benefit_4:
      "Verifizierte Gäste, sichere Zahlungen und Unterstützung durch unser Serviceteam.",
    benefit_heading_5: "Direkte Kommunikation:",
    benefit_5:
      "Einfach mit Hundebesitzern in Kontakt treten, um individuelle Wünsche zu klären.",
    benefit_heading_6: "10 % Provision auf den Übernachtungspreis: ",
    benefit_6: "Fair und transparent – ​​Sie zahlen nur bei einer Buchung.",
    how_it_works: "Wie es funktioniert",
    how_it_works_1:
      "Erstellen Sie Ihr Angebot - Fügen Sie Fotos und Beschreibungen hinzu und legen Sie Ihren Preis fest",
    how_it_works_2:
      "Begrüssen Sie Gäste und ihre Hunde - Bieten Sie ein unvergessliches Aufenthaltserlebnis",
    how_it_works_3:
      "Erhalten Sie Zahlungen - Sichere Zahlungen für jede Buchung",
    ready_to_start: "Bereit loszulegen?",
    start_hosting_text:
      "Schliessen Sie unseren einfachen Registrierungsprozess ab und beginnen Sie direkt mit der Vermietung Ihrer Unterkunft.",
    ...
    // Provider Earnings
    invoice_available_after_checkin: "Rechnung nach Check-in verfügbar",
    ...
    total_earnings: "Verdienst gelöscht",
    ...
    account_created_confirmation: "Ihr Anbieter-Konto wurde erstellt.",
    ...
    create_listing_desc:
      "Erstellen Sie Ihre erste Unterkunft und starten Sie mit dem Verwalten Ihrer Buchungen.",
    ...
    service_charge: "Transaktionsgebühr",
     restricted_stripe:" Ihr Konto wurde von Stripe eingeschränkt. Bitte kontaktieren Sie das Stripe-Supportteam und lassen Sie Ihr Konto entsperren.",
   click_here:"Klicken Sie auf den Link, um Kontakt aufzunehmen",
  },
};
