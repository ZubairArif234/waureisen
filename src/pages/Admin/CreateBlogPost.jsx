...
const normalizeUrl = (url) => {
  ...
  const validateForm = () => {
    ...
    if (!blogData.featuredImage && !imageFile) return 'Featured image is required';
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const cloudinaryUrl = imageFile ? await uploadImage() : blogData.featuredImage;
  ...
  return (
    <div className="p-6">
      ...
      {showPreview ? (
  /* Preview Mode */
  <div className="w-full"> {/* Remove max-width, padding, and border constraints */}
    {/* Featured Image at top with full width */}
    {blogData.featuredImage && (
      <div className="relative w-full h-[60vh]"> {/* Full height hero image */}
        <img 
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBlogData({...blogData, imageTitle: e.target.value})}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#B4A481]/20 focus:border-[#B4A481]"
