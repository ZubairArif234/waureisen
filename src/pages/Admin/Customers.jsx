        ...
        <div className="p-6">
          ...
          <div className="flex items-center mb-6">
            <div className="w-16 h-16 rounded-full overflow-hidden bg-gray-200 mr-4">
              <img
                src={
                  customer.profilePicture && customer.profilePicture !== "N/A"
            ...
            <div>
              ...
              <div
                className={`mt-1 text-sm ${
                  ...
                  customer.profileStatus === "pending verification"
                    ? "text-green-600"
                    : "text-red-600"
                }`}
              >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {dog.gender || "Gender not specified"}
                      </p>
                    </div>
                  </div>
                ))}
      ...
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-xl z-50 w-96 max-w-[90%]">
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6">
            ...
            <span className="font-medium">{customerName}</span>"? This action
...
const Customers = () => {
    ...
    (customer) =>
      (selectedStatus === "all" ||
        ...
        (selectedStatus === "pending" &&
          (customer.profileStatus === "pending verification" ||
            customer.profileStatus === "not verified"))) &&
  ...
  const handleDetailBanUnban = async (id, status) => {
    try {
      ...
      // Update local state
      setCustomers((prev) =>
        prev.map((c) => (c._id === id ? { ...c, profileStatus: status } : c))
      );
